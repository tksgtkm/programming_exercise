...
const file_proto_greeter_proto_rawDesc = "" +
	...
	"\aGreeter\x12<\n" +
	"\bSayHello\x12\x18.greeter.v1.HelloRequest\x1a\x16.greeter.v1.HelloReply\x12D\n" +
	"\x0eSayHelloStream\x12\x18.greeter.v1.HelloRequest\x1a\x16.greeter.v1.HelloReply0\x01B*Z(example.com/grpc-go-sample/gen/greeterpbb\x06proto3"
...
var file_proto_greeter_proto_depIdxs = []int32{
	...
	0, // 1: greeter.v1.Greeter.SayHelloStream:input_type -> greeter.v1.HelloRequest
	1, // 2: greeter.v1.Greeter.SayHello:output_type -> greeter.v1.HelloReply
	1, // 3: greeter.v1.Greeter.SayHelloStream:output_type -> greeter.v1.HelloReply
